...
INSERT INTO `EformPlugins` VALUES (1,'eform-angular-time-planning-plugin','host= localhost;Database=420_eform-angular-time-planning-plugin;user = root; password = secretpassword;port=3306;Convert Zero Datetime = true;SslMode=none;PersistSecurityInfo=true;',1,'0001-01-01 00:00:00.000000',0,NULL,0,0,NULL),(2,'eform-backend-configuration-plugin','host= localhost;Database=420_eform-backend-configuration-plugin;user = root; password = secretpassword;port=3306;Convert Zero Datetime = true;SslMode=none;PersistSecurityInfo=true;',1,'0001-01-01 00:00:00.000000',0,NULL,0,0,NULL),(3,'eform-angular-workflow-plugin','host= localhost;Database=420_eform-angular-workflow-plugin;user = root; password = secretpassword;port=3306;Convert Zero Datetime = true;SslMode=none;PersistSecurityInfo=true;',1,'0001-01-01 00:00:00.000000',0,NULL,0,0,NULL),(4,'eform-angular-items-planning-plugin','host= localhost;Database=420_eform-angular-items-planning-plugin;user = root; password = secretpassword;port=3306;Convert Zero Datetime = true;SslMode=none;PersistSecurityInfo=true;',1,'0001-01-01 00:00:00.000000',0,NULL,0,0,NULL),(5,'eform-angular-greate-belt-plugin','host= localhost;Database=420_eform-angular-greate-belt-plugin;user = root; password = secretpassword;port=3306;Convert Zero Datetime = true;SslMode=none;PersistSecurityInfo=true;',1,'0001-01-01 00:00:00.000000',0,NULL,0,0,NULL),(6,'eform-angular-insight-dashboard-plugin','host= localhost;Database=420_eform-angular-insight-dashboard-plugin;user = root; password = secretpassword;port=3306;Convert Zero Datetime = true;SslMode=none;PersistSecurityInfo=true;',1,'0001-01-01 00:00:00.000000',0,NULL,0,0,NULL),(7,'eform-angular-outer-inner-resource-plugin','host= localhost;Database=420_eform-angular-outer-inner-resource-plugin;user = root; password = secretpassword;port=3306;Convert Zero Datetime = true;SslMode=none;PersistSecurityInfo=true;',2,'0001-01-01 00:00:00.000000',0,NULL,0,0,NULL);
